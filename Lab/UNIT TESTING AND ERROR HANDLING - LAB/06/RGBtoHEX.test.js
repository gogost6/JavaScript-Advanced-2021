...
describe('RGBtoHEX', () => {
    ...
    it('convers green to hex', () => {
        expect(rgbToHexColor(0, 255, 0)).to.equal('#00FF00');
    });

    it('convers blue to hex', () => {
    ...
    it('returns undefined for string params', () => {
        expect(rgbToHexColor(0, 'a', 'a')).to.be.undefined;
    });
    
    it('returns undefined for string params', () => {
        expect(rgbToHexColor('a', 0, 'a')).to.be.undefined;
    });

    it('returns undefined for string params', () => {
        expect(rgbToHexColor('a', 'a', 0)).to.be.undefined;
    });
